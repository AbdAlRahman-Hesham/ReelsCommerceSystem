...
public class PaymobObj
{
    ...
    public PaymobSource_Data source_data { get; set; }
    public string api_source { get; set; }
    public object terminal_id { get; set; }
    public object merchant_commission { get; set; }
    ...
    public PaymobData1 data { get; set; }
    public bool is_hidden { get; set; }
    public PaymobPayment_Key_Claims payment_key_claims { get; set; }
    public bool error_occured { get; set; }
    public bool is_live { get; set; }
    public object other_endpoint_reference { get; set; }
    public object refunded_amount_cents { get; set; }
    public int source_id { get; set; }
    public bool is_captured { get; set; }
    public object captured_amount { get; set; }
...
public class PaymobOrder
{
    ...
    public int amount_cents { get; set; }
    public PaymobShipping_Data shipping_data { get; set; }
    public string currency { get; set; }
    ...
    public object commission_fees { get; set; }
    public object delivery_fees_cents { get; set; }
    public object delivery_vat_cents { get; set; }
...
public class PaymobShipping_Data
{
    public int id { get; set; }
...
public class PaymobSource_Data
{
...
public class PaymobData1
{
    ...
    public string currency { get; set; }
    public PaymobMigs_Order migs_order { get; set; }
    public string merchant { get; set; }
    public string migs_result { get; set; }
    public PaymobMigs_Transaction migs_transaction { get; set; }
...
public class PaymobMigs_Order
{
    ...
    public object totalRefundedAmount { get; set; }
}

public class PaymobChargeback
{
    public object amount { get; set; }
    public string currency { get; set; }
}

public class PaymobMigs_Transaction
{
    public PaymobAcquirer acquirer { get; set; }
    public int amount { get; set; }
    public string authenticationStatus { get; set; }
...
public class PaymobPayment_Key_Claims
{
